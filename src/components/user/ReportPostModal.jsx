...
const reasons = [
  ...
  { value: 'harassment', label: 'Taciz/Hakaret', icon: '😠' },
  { value: 'misinformation', label: 'Yanlış bilgi', icon: '❌' },
  { value: 'copyright', label: 'Telif hakkı ihlali', icon: '©️' },
            ...
            <div className="w-full max-w-md glass-card border border-white/10 rounded-3xl shadow-2xl overflow-hidden">
              ...
              <div className="p-6 border-b border-white/5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-black text-lg text-white">Gönderiyi Raporla</h3>
                </div>
                <button
                  onClick={handleClose}
              ...
              {sent ? (
                ...
                <div className="p-6 space-y-5">
                  ...
                  <div className="p-3 bg-white/5 border border-white/10 rounded-xl">
                    <p className="text-xs text-text-muted font-bold uppercase tracking-wider mb-1">Raporlanan Gönderi</p>
                    <p className="text-sm text-white line-clamp-2 font-medium">{post?.title}</p>
                    <p className="text-xs text-text-muted mt-2 line-clamp-2">{post?.content}</p>
                  </div>
