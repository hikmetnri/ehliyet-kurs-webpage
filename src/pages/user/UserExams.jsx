...
import { ExamTabBar, ShortTestsTab, GeneralTab, WrongAnswersTab } from './exams/ExamTabs';
      ...
      <div className="flutter-mobile flutter-exams block lg:hidden">
        {activeTab === 'real_sim_cat' ? (
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <ExamTabBar activeTab={activeTab} handleTabChange={handleTabChange} />
