...
import {
  Activity, AlertCircle, ArrowRight, Bell, BookOpen, CalendarDays, CheckCircle2, ChevronRight, Flame, GraduationCap, Lock, Monitor, Moon, Play, PlayCircle, Quote, RefreshCcw, Settings2, ShieldCheck, Sparkles, Star, Sun, Target, Zap,
} from 'lucide-react';
import { Link } from 'react-router-dom';
import { TEST_TYPES } from '../../../constants/testTypes';
import {
  getCategoryColor, getCategoryIcon, planRouteByAction,
} from './homeHelpers';
...
export const MobileHomeView = ({
  ...
  radius,
  recommendation,
  recommendationBgMobile,
  recommendationBorderMobile,
  recommendationColorMobile,
  remainingQuestions,
  reviewDue,
  selectedPackage,
  setShowCategoryModal,
